...
public:
	...
	static std::shared_ptr<SpeedController> shooterShooterFeedingMotor;
	static std::shared_ptr<DigitalInput> shooterLeftLimit;
	static std::shared_ptr<DigitalInput> shooterRightLimit;
