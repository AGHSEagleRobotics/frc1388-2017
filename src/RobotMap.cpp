...
void RobotMap::init() {
    ...
    driveTrainLeftFront.reset(new TalonSRX(9));
    lw->AddActuator("DriveTrain", "LeftFront", std::static_pointer_cast<TalonSRX>(driveTrainLeftFront));
    
    driveTrainLeftRear.reset(new TalonSRX(8));
    lw->AddActuator("DriveTrain", "LeftRear", std::static_pointer_cast<TalonSRX>(driveTrainLeftRear));
    
    driveTrainRightFront.reset(new TalonSRX(6));
    lw->AddActuator("DriveTrain", "RightFront", std::static_pointer_cast<TalonSRX>(driveTrainRightFront));
    
    driveTrainRightRear.reset(new TalonSRX(7));
    lw->AddActuator("DriveTrain", "RightRear", std::static_pointer_cast<TalonSRX>(driveTrainRightRear));
