...
std::shared_ptr<SpeedController> RobotMap::shooterShooterFeedingMotor;
std::shared_ptr<DigitalInput> RobotMap::shooterLeftLimit;
std::shared_ptr<DigitalInput> RobotMap::shooterRightLimit;
...
void RobotMap::init() {
    ...
    shooterShooterFeedingMotor.reset(new Talon(5));
    lw->AddActuator("Shooter", "ShooterFeedingMotor", std::static_pointer_cast<Talon>(shooterShooterFeedingMotor));
    
    shooterLeftLimit.reset(new DigitalInput(0));
    lw->AddSensor("Shooter", "LeftLimit", shooterLeftLimit);
    
    shooterRightLimit.reset(new DigitalInput(1));
    lw->AddSensor("Shooter", "RightLimit", shooterRightLimit);
