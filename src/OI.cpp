...
#include "Commands/AimInitializer.h"
...
OI::OI() {
    ...
    intakeOn.reset(new JoystickButton(opStick.get(), 6));
    intakeOn->WhenPressed(new Intake());
    intakeOff.reset(new JoystickButton(opStick.get(), 5));
    ...
    bumpP.reset(new JoystickButton(rightStick.get(), 11));
    bumpP->WhenPressed(new increaseP());
    lowerI.reset(new JoystickButton(rightStick.get(), 10));
    lowerI->WhenPressed(new decreaseI());
    lowerP.reset(new JoystickButton(rightStick.get(), 7));
    lowerP->WhenPressed(new decreaseP());
    bumpI.reset(new JoystickButton(rightStick.get(), 6));
