...
OI::OI() {
    ...
    bumpI.reset(new JoystickButton(opStick.get(), 29));
    bumpI->WhenPressed(new increaseI());
    lowerP.reset(new JoystickButton(opStick.get(), 30));
    lowerP->WhenPressed(new decreaseP());
    lowerI.reset(new JoystickButton(opStick.get(), 31));
    lowerI->WhenPressed(new decreaseI());
    bumpP.reset(new JoystickButton(opStick.get(), 32));
