...
OI::OI() {
    ...
    SmartDashboard::PutNumber("Shooter Power", RobotMap::shooterShootingMotor->Get());
   // SmartDashboard::PutBoolean()("Ball Intake Motor 1", RobotMap::ballIntakeIntakeMotor1->);
}

	bool ballIntakeMotor1On()
	{
		return RobotMap::ballIntakeIntakeMotor1->Get();
